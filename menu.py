...
def iniciar():
    while True:
        ...
        if opcion == '2':
            ...
            dni = helpers.leer_texto(3,3, "DNI (2 ins y 1 char)").upper()
        ...
        if opcion == '3':
            ...
            nombre = helpers.leer_texto(2, 30, "Nombre (2 ins y 30 chars)").capitalize()
            apellido = helpers.leer_texto(2, 30, "Apellido (2 ins y 30 chars)").capitalize()
